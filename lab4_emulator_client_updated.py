...
class MQTTClient:
    def __init__(self, device_id, cert, key):
        ...
        self.client.configureEndpoint(
            "a3odsns9m7sufx-ats.iot.us-east-1.amazonaws.com", 8883)
        self.client.configureCredentials(
            "credential/Amazon-root-CA-1.pem", key, cert)
    ...
    def publish(self, Payload="payload"):
        ...
        self.client.subscribeAsync(
            "myTopic", 0, ackCallback=self.customSubackCallback)
...
for device_id in range(device_st, device_end):
    client = MQTTClient(device_id, certificate_formatter.format(
        device_id, device_id), key_formatter.format(device_id, device_id))
