...
class MQTTClient:
    def __init__(self, device_id, cert, key):
        ...
        self.client.configureEndpoint("aawlik2ocbcqv-ats.iot.us-east-2.amazonaws.com", 8883)
        self.client.configureCredentials("E:\Illinois_in\CS437\Lab4\AmazonRootCA1.pem", key, cert)
